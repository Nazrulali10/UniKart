...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative z-40 transition-all">
      <NavLink to="/" onClick={() => setOpen(false)}>
        <img className="h-9" src="unikart.jpg" alt="unikart" />
      </NavLink>
      ...
      {/* Mobile Menu */}
      {open && (
        <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden flex z-40">
          {/* ✅ Mobile Search Input */}
          <div className="flex w-full items-center gap-2 border border-black px-3 rounded-full mb-2">
            <input
              onChange={(e) => {
                setSearchQuery(e.target.value);
              }}
          ...
          <NavLink to="/" onClick={() => setOpen(false)} className="hover:text-blue-600 transition-colors">
            Home
          </NavLink>
          <NavLink to="/products" onClick={() => setOpen(false)} className="hover:text-blue-600 transition-colors">
            All products
          </NavLink>
          {user && (
            <NavLink to="/my-orders" onClick={() => setOpen(false)} className="hover:text-blue-600 transition-colors">
              My orders
            </NavLink>
          )}
          <NavLink to="/add-address" onClick={() => setOpen(false)} className="hover:text-blue-600 transition-colors">
            Contacts
          </NavLink>
